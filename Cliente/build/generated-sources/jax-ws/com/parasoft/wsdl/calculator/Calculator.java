 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://www.parasoft.com/wsdl/calculator/", wsdlLocation = "http://soaptest.parasoft.com/calculator.wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://www.parasoft.com/wsdl/calculator/", "Calculator");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://soaptest.parasoft.com/calculator.wsdl");
    ...
    public ICalculator getICalculator() {
        return super.getPort(new QName("http://www.parasoft.com/wsdl/calculator/", "ICalculator"), ICalculator.class);
    }
    ...
    public ICalculator getICalculator(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.parasoft.com/wsdl/calculator/", "ICalculator"), ICalculator.class, features);
    }
